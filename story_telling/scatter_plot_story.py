...
def get_text_below_scatter():
    return html.Div([
        ...
        html.P("Pour conclure, il y a globalement une consistance durant ces 8 dernières années concernant les gravités des incidents de la sécurité, et il n'y a pas de réelle variabilité forte dans les gravités en fonction de chaque mois.")
