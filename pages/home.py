...
layout = html.Div(style={'color': 'black', 'min-height': '100vh'}, children=[
    ...
    html.Div(style={'color': 'black'}, children=[
        ...
        html.Br(),
        html.P("Nos deux premières bases de données concernant les incidents de 2015 à 2022 et de 2023, continnent des informations sur les incidents : "
                "la date, l'origine, le type d'événement, la région et le lieu et ainsi que le niveau de gravité.", style={'fontSize': '1.25em'}),
        html.P("Chaque incident est classé selon l'échelle de gravité ci-dessous (de 1 à 6). Comme c'est indiqué, cette échelle à été mise en place en 2016, "
        ...
        html.P("Dans nos 3 bases de données concernant les lignes, nous allons nous intérésser aux colonnes des coordonnées géographiques et des régions, dans le but de construire des cartes pour les visualiser."
                , style={'fontSize': '1.25em'}),
        
        html.P("Enfin dans la base de données de la météo, parmis les 82 colonnes, nous allons nous intéresser à la température, la date, la région, les précipitations, et les coordonnées géographiques."
                , style={'fontSize': '1.25em'}),
    ])
])
